...
public class ReservationService implements ReservationFacade {
    ...
    @Override
    public Reservation create(User currentUser, Long offerId, Integer quantity) {
        ...
        Reservation reservation = Reservation.reserve(offerId, currentUser.getId(), requestedQuantity);
    ...
    public Reservation cancel(User currentUser, Long id) {
        ...
        reservation.cancel();
        offer.restoreQuantity(reservation.getQuantity());
